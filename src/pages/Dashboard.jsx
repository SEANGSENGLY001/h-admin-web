        ...
        return (
          <>
            ...
            <div className="quick-actions">
              <button className="qa-card" onClick={() => { setActiveNav("movies"); }}>
              ...
              <button className="qa-card" onClick={() => { setActiveNav("tvshows"); }}>
                <div className="qa-icon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button className="qa-card" onClick={() => { setActiveNav("schedule"); }}>
                <div className="qa-icon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button className="qa-card" onClick={() => { setActiveNav("users"); }}>
                <div className="qa-icon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {recentUploads.map((item) => (
                    <div key={item.id} className="uploads-row">
                      ...
                      <div className="uploads-actions">
                        <button title="Edit" onClick={(e) => { e.stopPropagation(); setActiveNav(item.contentType === "movie" ? "movies" : "tvshows"); }}>
    ...
    <div className="dashboard">
      <aside className={`sidebar${sidebarOpen ? "" : " collapsed"}`}>
        ...
        <div className="sidebar-footer">
          <button className="sidebar-link" onClick={() => setActiveNav("settings")}>
      ...
      <div className="main-area">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <button className="topbar-btn" title="Go to Settings" onClick={() => setActiveNav("settings")}>
              <Svg><circle cx="12" cy="12" r="3" /><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" /></Svg>
            </button>
